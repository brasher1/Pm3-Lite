...
typedef struct {
    int nEleType;
    char *pszEleName;
    int (*fpEleCB)( FILE *fp, Ptg3DNode *theParent );
} eleCB; 

char *getFixedField( char *string, int fieldWidth, int fieldIndex );

int createHierLevel( FILE *fp, Ptg3DNode *theParent );
int createBox( FILE *fp, Ptg3DNode *theParent );
int createCylinder( FILE *fp, Ptg3DNode *theParent );
int createPyramid( FILE *fp, Ptg3DNode *theParent );
int createRectTorus( FILE *fp, Ptg3DNode *theParent );
int createCircTorus( FILE *fp, Ptg3DNode *theParent );
int createSnout( FILE *fp, Ptg3DNode *theParent );
int createSRect( FILE *fp, Ptg3DNode *theParent );
int createFacet( FILE *fp, Ptg3DNode *theParent );
...
nPrimCount = 0;
    ...
    if( pszReviewFile == NULL || theParent == NULL )
    {
	...
	if( strcmp( szLine, "CNTB" ) == 0 )
	    createHierLevel( fpReviewFile, theParent );
    }
...
int createHierLevel( FILE *fp, Ptg3DNode *theParent )
{
    ...
    readLine( szLine, sizeof(szLine), fp );	/* name */
...
int setTransform( FILE *fp, Ptg3DNode *theNode, int bSwapAxes )
{
    char szLine[MAX_LINE_LENGTH];
    ...
    (*theMatrix)[0][0] = 1000.0*atof(getFixedField( szLine, 14, 0 ));
    (*theMatrix)[1][0] = 1000.0*atof(getFixedField( szLine, 14, 1 ));
    (*theMatrix)[2][0] = 1000.0*atof(getFixedField( szLine, 14, 2 ));
    v[10] = 1000.0*atof(getFixedField( szLine, 14, 3 ));

    readLine( szLine, sizeof(szLine), fp );	/* second line of xform */
    (*theMatrix)[0][1] = 1000.0*atof(getFixedField( szLine, 14, 0 ));
    (*theMatrix)[1][1] = 1000.0*atof(getFixedField( szLine, 14, 1 ));
    (*theMatrix)[2][1] = 1000.0*atof(getFixedField( szLine, 14, 2 ));
    v[11] = 1000.0*atof(getFixedField( szLine, 14, 3 ));

    readLine( szLine, sizeof(szLine), fp );	/* third line of xform */
    (*theMatrix)[0][2] = 1000.0*atof(getFixedField( szLine, 14, 0 ));
    (*theMatrix)[1][2] = 1000.0*atof(getFixedField( szLine, 14, 1 ));
    (*theMatrix)[2][2] = 1000.0*atof(getFixedField( szLine, 14, 2 ));
    v[12] = 1000.0*atof(getFixedField( szLine, 14, 3 ));
#endif

    readLine( szLine, sizeof(szLine), fp );	/* first line of xform */
    (*theMatrix)[0][0] = 1000.0*atof(getFixedField( szLine, 14, 0 ));
    (*theMatrix)[0][1] = 1000.0*atof(getFixedField( szLine, 14, 1 ));
    (*theMatrix)[0][2] = 1000.0*atof(getFixedField( szLine, 14, 2 ));
    v[10] = 1000.0*atof(getFixedField( szLine, 14, 3 ));

    readLine( szLine, sizeof(szLine), fp );	/* second line of xform */
    (*theMatrix)[1][0] = 1000.0*atof(getFixedField( szLine, 14, 0 ));
    (*theMatrix)[1][1] = 1000.0*atof(getFixedField( szLine, 14, 1 ));
    (*theMatrix)[1][2] = 1000.0*atof(getFixedField( szLine, 14, 2 ));
    v[11] = 1000.0*atof(getFixedField( szLine, 14, 3 ));

    readLine( szLine, sizeof(szLine), fp );	/* third line of xform */
    (*theMatrix)[2][0] = 1000.0*atof(getFixedField( szLine, 14, 0 ));
    (*theMatrix)[2][1] = 1000.0*atof(getFixedField( szLine, 14, 1 ));
    (*theMatrix)[2][2] = 1000.0*atof(getFixedField( szLine, 14, 2 ));
    v[12] = 1000.0*atof(getFixedField( szLine, 14, 3 ));
...
int createRectTorus( FILE *fp, Ptg3DNode *theParent )
{
    ...
    float color[4];
    theParent->getColor( color );
    newRtor->setColor( color[0], color[1], color[2], color[3] );
...
int createCircTorus( FILE *fp, Ptg3DNode *theParent )
{
    ...
    float color[4];
    theParent->getColor( color );
    newCtor->setColor( color[0], color[1], color[2], color[3] );
...
int createSnout( FILE *fp, Ptg3DNode *theParent )
{
    ...
    float color[4];
    theParent->getColor( color );
    newCone->setColor( color[0], color[1], color[2], color[3] );
...
int createFacet( FILE *fp, Ptg3DNode *theParent )
{
    ...
    setTransform( fp, facetGroup, FALSE );
